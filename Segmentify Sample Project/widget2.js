document.addEventListener("DOMContentLoaded", () => {
    ...
    const leftClick = document.querySelector("#leftclick2");
    const rightClick = document.querySelector("#rightclick2");
    let index = 0;


    const fetchProductsData2 = () => {
                ...
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-footer bg-white border-0 mt-4">
                            <p class=" text-center">
                                <b class="text-success">${products[i].priceText}</b> <span class="text-danger"><del>${products[i].oldPriceText}</del></span> 
                            </p>
                        </div>
